...
const DEFAULTS = {
  ...
  contactEmail: 'support@trio.store',
  ...
  footerCopyright: 'TRIO. All rights reserved.',
  socialLinks: { facebook: '#', instagram: '#', x: '#', youtube: '#' },
  metaTitle: 'TRIO — Premium Electronics Store',
  metaDescription: 'Shop the latest electronics, smartphones, laptops, and accessories at TRIO.',
  bankName: 'HBL',
